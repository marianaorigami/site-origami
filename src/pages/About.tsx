        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-12">
          <MotionFade delay={0.1}>
            <div className="flex flex-col-reverse md:flex-row items-center gap-12">
              <div className="flex-1 text-black text-justify tracking-tight leading-relaxed">
                Fundada em 2023, a Origami Lab conta com o propósito de
                transformar negócios através da inovação com disciplina. Sediada
                no Centro-Oeste de Minas Gerais, somos pioneiros na região,
                unimos estratégia, tecnologia e design para ajudar organizações
                a se reinventarem frente aos desafios do presente e do futuro.
                Nosso time é liderado por profissionais com sólida experiência
          ...
          <MotionFade delay={0.2}>
            <div className="flex flex-col md:flex-row items-center justify-between gap-12 border px-24 py-8 transition-all duration-300 hover:shadow-md">
              <div className="md:w-1/2 text-black text-justify text-lg tracking-tight leading-relaxed">
                ...
                por projetos no Brasil e no exterior, é especialista em usar
                tecnologia e design estratégico para impulsionar resultados e
          ...
          <MotionFade delay={0.3}>
            <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-12 mb-12 border px-24 py-8 transition-all duration-300 hover:shadow-md">
              <div className="md:w-1/2 text-black text-justify text-lg tracking-tight leading-relaxed">
                ...
                mais de 8 anos em tecnologia, marcada pela entrega de soluções
                utilizadas por milhões de brasileiros e pela atuação em projetos
                internacionais, destaca-se por sua visão estratégica, excelência
                técnica e forte liderança.
              </div>
          ...
          <MotionFade delay={0.3}>
            <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-12 mb-12 border px-24 py-8 transition-all duration-300 hover:shadow-md">
              ...
              <div className="md:w-1/2 text-black text-justify text-lg tracking-tight leading-relaxed">
                Guilherme Valadares, Especialista em Marketing e Mercados pela
                Fundação Dom Cabral, possui mais de sete anos de experiência no
                mercado de tecnologia, já liderou lançamentos de soluções
                globais para Europa e América Latina e criou produtos de grande
                escala no Brasil.
              </div>
            </div>
          </MotionFade>
          ...
          <MotionFade delay={0.4}>
            <div className="flex flex-col-reverse md:flex-row items-center gap-12 mb-16">
              <h2 className="text-3xl md:text-4xl text-center font-black bg-text-gradient bg-clip-text text-transparent">
                Trabalhamos para transformar desafios em soluções concretas, com
                método, visão e impacto real.
              </h2>
            </div>
          </MotionFade>
        </div>
